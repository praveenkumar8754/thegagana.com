...
function filter_smilies(s) {
	for (var i = 0; i < smilies.length; i++) {
		...
		var imgsrc = 'https://thegagana.com/wp-includes/images/smilies/' + smilies[i][1];
...
var GetChaturl  = 'https://thegagana.com/wp-content/plugins/simple-ajax-chat/simple-ajax-chat-core.php?sacGetChat=yes';
var SendChaturl = 'https://thegagana.com/wp-content/plugins/simple-ajax-chat/simple-ajax-chat-core.php?sacSendChat=yes';
...
function receiveChatText() {
	...
	if (httpReceiveChat.readyState == 4 || httpReceiveChat.readyState == 0) {
		...
		var nonce = '&sac_nonce_receive=33f836ef36';
...
function insertNewContent(liName,liText,lastResponse, liUrl, liId) {
	...
	insertO.insertBefore(oLi, insertO.lastChild);
		...
		jQuery.post('https://thegagana.com/wp-content/plugins/simple-ajax-chat/includes/sac-check-user.php', 'sac_user=' + encodeURIComponent(liName), function(response){
...
function checkName() {
	...
	chat_name = 'thegagana.com';
		
	if (currentName.value != chat_name) {
		currentName.value = chat_name;
	}
	if (chat_name != sacCookie) {
		document.cookie = 'sacUserName=' + chat_name + '; expires=Tue, 21 Nov 2023 01:06:13 UTC; samesite=strict;';
	}
...
function checkUrl() {
	...
	if (currentName.value != sacCookie) {
		document.cookie = 'sacUrl=' + currentName.value + '; expires=Tue, 21 Nov 2023 01:06:13 UTC; samesite=strict;';
		return;
	}
...
jQuery(document).ready(function($){
	...
	// nonce
	var url = 'https://thegagana.com/wp-content/plugins/simple-ajax-chat/resources/nonce.php';
...
function sacCustomNotify(title, desc, url) {
	if (window.Notification && Notification.permission == 'granted') {
		var notification = new Notification(title, {
			icon: 'https://thegagana.com/wp-content/plugins/simple-ajax-chat/resources/sac-400.png',
			body: desc,
		});
		if (url) {
