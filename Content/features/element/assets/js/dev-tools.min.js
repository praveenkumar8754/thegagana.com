...
(() => {
    var e = {
                    ...
                    u = function() {
                        ...
                        return (0, s.default)(Deprecation, [{
                            ...
                            value: function getTotalMajor(e) {
                                ...
                                return r = Number((r / 10).toFixed(0)), e.major2 > 9 && (r = e.major2 - 9), r
                            }
                        }, {
                            key: "compareVersion",
                            value: function compareVersion(e, r) {
                                var t = this;
                                return [this.parseVersion(e), this.parseVersion(r)].map((function(e) {
                            ...
                            value: function isHardDeprecated(e) {
                                ...
                                return r < 0 || r >= elementorDevToolsConfig.deprecation.hard_version_count
                            }
                        }]), Deprecation
                    }();
                r.default = u
            ...
            26415: (e, r, t) => {
                ...
                var n = o(t(9833)),
                    ...
                    l = (o(t(2557)), function() {
                        function Module(e) {
                            (0, s.default)(this, Module), (0, u.default)(this, "deprecation", void 0), this.deprecation = e
                        }
                        return (0, i.default)(Module, [{
                            ...
                            value: function notifyBackendDeprecations() {
                                ...
                                Object.entries(r).forEach((function(r) {
                                    var t, o = (0, a.default)(r, 2),
                                        s = o[0],
                                        i = o[1];
                                    (t = e.deprecation).deprecated.apply(t, [s].concat((0, n.default)(i)))
                                }))
                            }
                        }, {
                            key: "consoleWarn",
                            value: function consoleWarn() {
                                for (var e, r = 'font-size: 12px; background-image: url("'.concat(elementorDevToolsConfig.urls.assets, 'images/logo-icon.png"); background-repeat: no-repeat; background-size: contain;'), t = arguments.length, o = new Array(t), n = 0; n < t; n++) o[n] = arguments[n];
                                o.unshift("%c  %c", r, ""), (e = console).warn.apply(e, o)
                            }
                        }]), Module
                    }());
                r.default = l
                    ...
                    if (null != t) {
                        ...
                        try {
                            if (a = (t = t.call(e)).next, 0 === r) {
                                ...
                                for (; !(u = (o = a.call(t)).done) && (i.push(o.value), i.length !== r); u = !0);
                        } catch (e) {
                            l = !0, n = e
                        } finally {
                            try {
            ...
            7501: e => {
                function _typeof(r) {
                    ...
                    }, e.exports.__esModule = !0, e.exports.default = e.exports, _typeof(r)
                }
    ...
    function __webpack_require__(t) {
        ...
        return e[t](n, n.exports, __webpack_require__), n.exports
    }(() => {
        "use strict";
        var e = __webpack_require__(73203),
            r = e(__webpack_require__(2557)),
            t = e(__webpack_require__(26415));
        window.elementorDevTools || (window.elementorDevTools = new t.default(new r.default), window.elementorDevTools.notifyBackendDeprecations())
    })()
})();