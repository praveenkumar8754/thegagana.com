...
(() => {
    var e = {
            ...
            51121: (e, t, r) => {
                ...
                function _get() {
                    return "undefined" != typeof Reflect && Reflect.get ? (e.exports = _get = Reflect.get.bind(), e.exports.__esModule = !0, e.exports.default = e.exports) : (e.exports = _get = function _get(e, t, r) {
                        var o = n(e, t);
                        if (o) {
            ...
            74910: e => {
                function _getPrototypeOf(t) {
                    return e.exports = _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(e) {
            ...
            96196: e => {
                function _setPrototypeOf(t, r) {
                    return e.exports = _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(e, t) {
                        return e.__proto__ = t, e
                    }, e.exports.__esModule = !0, e.exports.default = e.exports, _setPrototypeOf(t, r)
                }
    ...
    function __webpack_require__(r) {
        ...
        return e[r](o, o.exports, __webpack_require__), o.exports
    }(() => {
        "use strict";
        var e = __webpack_require__(73203),
            t = e(__webpack_require__(78983)),
            r = e(__webpack_require__(42081)),
            n = e(__webpack_require__(51121)),
            o = e(__webpack_require__(58724)),
            s = e(__webpack_require__(71173)),
            u = e(__webpack_require__(74910));
        ...
        var a = function(e) {
            (0, o.default)(AdminBar, e);
            var s = _createSuper(AdminBar);

            function AdminBar() {
                return (0, t.default)(this, AdminBar), s.apply(this, arguments)
            }
            return (0, r.default)(AdminBar, [{
                ...
                value: function getDefaultElements() {
                    ...
                    return {
                        $adminBar: jQuery(t),
                        $editMenuItem: jQuery(r),
                        $newMenuItem: jQuery(n)
                    }
                }
            }, {
                key: "onInit",
                value: function onInit() {
                    (0, n.default)((0, u.default)(AdminBar.prototype), "onInit", this).call(this), this.createMenu(elementorAdminBarConfig)
                }
            }, {
                key: "createMenu",
                value: function createMenu(e) {
                    var t = this.createMenuItems(Object.values(e));
                    this.elements.$editMenuItem.length ? this.elements.$editMenuItem.after(t) : this.elements.$newMenuItem.length ? this.elements.$newMenuItem.after(t) : this.elements.$adminBar.append(t)
                }
            }, {
                key: "createMenuItems",
                value: function createMenuItems(e) {
                    var t = this;
                ...
                value: function createMenuItem(e) {
                    var t = e.children ? Object.values(e.children) : [],
                        r = "".concat(this.getSettings("prefixes.adminBarId")).concat(e.id),
                        n = jQuery("<span>", {
                            class: this.getSettings("classes.adminBarItemTitle"),
                            html: e.title
                        }),
                        o = e.sub_title ? jQuery("<span>", {
                            class: this.getSettings("classes.adminBarItemSubTitle"),
                            html: e.sub_title
                        }) : null,
                        s = jQuery(e.href ? "<a>" : "<div>", {
                            "aria-haspopup": !!t.length || null,
                            class: [this.getSettings("classes.adminBarItem"), e.href ? "" : this.getSettings("classes.adminBarNonLinkItem"), e.class].join(" "),
                            href: e.href
                        }).append([n, o]);
                    return jQuery("<li>", {
                        id: r,
                        class: t.length ? "menupop" : "" + (e.parent_class || "elementor-general-section")
                    }).append([s, t.length ? this.createSubMenuItems(r, t) : null])
                }
            }, {
                key: "createSubMenuItems",
                value: function createSubMenuItems(e, t) {
                    var r = jQuery("<ul>", {
                        class: this.getSettings("classes.adminBarSubItems"),
                        id: "".concat(e, "-default")
                    }).append(this.createMenuItems(t));
                    return jQuery("<div>", {
